...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--movies',
            type=int,
            help='This flag will query through DB and write out info about movies starring selected actor in lead role. To select an actor write a positive number after the flag ',
        )
        parser.add_argument(
